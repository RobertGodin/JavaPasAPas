/** ExerciceIfMax3.java Lire trois entiers et afficher le maximum des trois */
...
public class ExerciceIfMax3 {
  ...
  public static void main(String args[]) {
    ...
    if (entier1 > entier2)
      ...
      else JOptionPane.showMessageDialog(null, "Le maximum des trois entiers est " + entier3);
