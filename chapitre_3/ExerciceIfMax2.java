/** ExerciceIfMax2.java Lire trois entiers et afficher le maximum des trois */
...
public class ExerciceIfMax2 {
  ...
  public static void main(String args[]) {
    ...
    else JOptionPane.showMessageDialog(null, "Le maximum des deux entiers est " + entier2);
