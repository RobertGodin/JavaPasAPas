...
public class ExerciceIf2{
    ...
    if (entier1 > entier2)
        ...
        if (entier2 > entier3)
            JOptionPane.showMessageDialog(null,"Le deuxième nombre est le plus grand, c'est-�-dire " +entier2);
        else
            JOptionPane.showMessageDialog(null,"Le troisi�me nombre est le plus grand, c'est-�-dire " +entier3);
    System.exit(0);
    }
}