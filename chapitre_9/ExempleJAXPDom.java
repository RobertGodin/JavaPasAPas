...
/**
 * Program to echo a DOM tree using DOM Level 2 interfaces. Use JAXP to read in and create a DOM
 * tree. DOM currently does not provide a method to do this. (This is planned for Level 3.) See the
 * method main for the three basic steps. Once the application obtains a DOM Document tree, it dumps
 * out the nodes in the tree and associated node attributes for each node.
 *
 * <p>Notes: Program flags may be used to create possibly non-conformant (but useful) DOM trees.
 * Program also shows an example of using an ErrorHandler.
 *
